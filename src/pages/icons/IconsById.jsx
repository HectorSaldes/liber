...
const IconsById = () => {
  ...
  const searchIcons = () => {
    ...
    if (valueSelected.length > 0) {
      IconsService.getIcon(valueSelected).then((data) => {
    ...
    <div className="p-4">
          ...
          <div className="grid">
            <div className="col-12 md:col-6">
               <span className="p-input-icon-left w-full">
                    ...
                    <InputText placeholder="Search ID" style={{ width: "100%" }}
                               value={valueSelected}
      ...
      <div className="text-center" style={{ fontSize: "1.2em" }}>
        ...
        <a
          ...
          target="_blank" rel="noreferrer">How can I get the ID of an Icon?</a>
      </div>
      {iconFounded ? (
