...
export default function IconsByWord() {
	...
	const getPlatformStyles = () => {
		IconsService.getPlatformsStyles()
			.then((data) => {
				setPlatformList(
					Object.values(data.data.result).map((item) => {
	...
	return (
		<div className='p-4'>
			...
			<div className='text-center'>
				<Title
					title='Icons by word'
					description='Here you can download icons, whatever you want i think'
				/>
			</div>
			<Search
			...
			<div className='grid'>
				{valueSelected === null ? (
					<EmptySearch title='icons' color='green' />
