...
class IconsService {
  ...
  getPlatformsStyles() {
    return axios.get(`${CORS_ENDPONIT}https://api.icons8.com/api/iconsets/v3/platforms`);
  }

  searchById(id) {
    return axios.get(`${CORS_ENDPONIT}https://api-icons.icons8.com/siteApi/icons/icon?id=${id}&svg=true`);
  }
